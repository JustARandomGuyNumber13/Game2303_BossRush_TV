...
namespace brolive
{
    ...
    public class Adjusted_EnemyTest : MonoBehaviour
    {
        [SerializeField] private bool isCustomEnemyTest = false;
        [SerializeField] private Custom_Animator_For_Enemy _animation;
        ...
        void UpdateIdle()
        {
            ...
            if (currentStateElapsed > 2.0f)
            {
                ...
                {
                    EnterMelee();
                    if(isCustomEnemyTest)
                        _animation?.SetChase(false);//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                }
                else
                {
                    if (AttemptBeginPursue())
                        if(isCustomEnemyTest)
        ...
        IEnumerator HandleMelee()
        {
            ...
            {
                yield return new WaitForSeconds(_animation.Attack()); //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            }
